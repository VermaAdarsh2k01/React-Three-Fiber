...
const FourthSection = () => {
  ...
  return (
    <div ref={containerRef} className='third-section h-[100vh] w-full overflow-hidden relative rounded-b-[4rem] bg-white'>
        ...
        <div className='absolute bottom-[60%] xs:bottom-[40%] md:bottom-[50%] lg:top-[20%] left-[6%] lg:left-[10%] xl:left-[15%] w-[35%] lg:w-[25%] xl:w-[20%] pointer-events-none flex flex-col text-left fourth-stagger'>
