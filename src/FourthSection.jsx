...
const FourthSection = () => {
  ...
  return (
    <div className='third-section h-[100vh] w-full overflow-hidden relative rounded-b-[4rem] bg-white'>
        ...
        <div className='absolute bottom-[30%] xs:bottom-[50%] lg:top-[20%] xs:left-[6%] lg:left-[15%] w-[35%] lg:w-[20%] pointer-events-none flex flex-col text-left'>
            <img src="/ArrowRight.png" className='w-[60%] lg:w-[40%] lg:ml-auto transform rotate-180 '/>
            <p className='haas-med text-[1.2rem] xs:text-[1.5rem] leading-none lg:whitespace-nowrap'>Ergonomic Contour-Glide Head</p>
        ...
        {isMobile ? (
          (<div className='absolute bottom-[30%] xs:bottom-[50%] lg:top-[20%] right-[6%] lg:right-[15%] w-[35%] lg:w-[20%] pointer-events-none flex flex-col text-right'>
        ...
        ) : (<div className='absolute bottom-[30%] lg:top-[20%] right-[6%] lg:right-[15%] w-[30%] lg:w-[20%] pointer-events-none flex flex-col text-right'>
            
          <p className='haas-med text-[1.5rem] leading-none lg:whitespace-nowrap'>Clear Reserve Window </p>
          <p className='haas text-[0.9rem] xs:text-[1rem] leading-none mt-2'>A matte, rubberized coating resists fingerprints and offers a secure grip—even with wet hands. A slim, crystal-clear window lets users see exactly how much stick remains, eliminating guesswork and last-minute repurchases.</p>
