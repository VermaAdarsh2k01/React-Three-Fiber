...
const ThirdSection = () => {
  ...
  return (
    <div className='third-section h-[100vh] w-full overflow-hidden relative'>
        <div className='absolute lg:-top-10 left-1/2 -translate-x-1/2 w-full pointer-events-none flex justify-center'>
            <div className='relative'>
                ...
                <p 
                    className='haas-black text-[8rem] xs:text-[11rem] lg:text-[20rem] leading-none whitespace-nowrap tracking-[-0.01rem] lg:tracking-[-0.15em] opacity-0'
                >
                    SUMMR
                </p>
            </div>
        ...
        <div className='absolute bottom-[10%] lg:bottom-[20%] left-[6%] lg:left-[15%] w-[30%] lg:w-[20%] pointer-events-none flex flex-col text-left'>
        ...
        <div className='absolute bottom-[40%] lg:bottom-[20%] right-[6%] lg:right-[15%] w-[30%] lg:w-[20%] pointer-events-none flex flex-col text-right'>
