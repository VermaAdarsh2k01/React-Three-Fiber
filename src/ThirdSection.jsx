...
const ThirdSection = () => {
  ...
  return (
    <div className='third-section h-[100vh] w-full overflow-hidden relative'>
        ...
        <div className='absolute bottom-[10%] lg:bottom-[20%] left-[6%] lg:left-[10%] xl:left-[15%] w-[30%] lg:w-[25%] xl:w-[20%] pointer-events-none flex flex-col text-left'>
        ...
        <div className='absolute bottom-[40%] lg:bottom-[20%] right-[6%] lg:right-[10%] xl:right-[15%] w-[30%] lg:w-[25%] xl:w-[20%] pointer-events-none flex flex-col text-right'>
